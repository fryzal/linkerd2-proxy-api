...
type BigIceAuth struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Unused uint32 `protobuf:"varint,1,opt,name=unused,proto3" json:"unused,omitempty"`
}

func (x *BigIceAuth) Reset() {
	*x = BigIceAuth{}
	if protoimpl.UnsafeEnabled {
...
func (x *BigIceAuth) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BigIceAuth) ProtoMessage() {}

func (x *BigIceAuth) ProtoReflect() protoreflect.Message {
	mi := &file_http_route_proto_msgTypes[10]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BigIceAuth.ProtoReflect.Descriptor instead.
func (*BigIceAuth) Descriptor() ([]byte, []int) {
	return file_http_route_proto_rawDescGZIP(), []int{10}
}

func (x *BigIceAuth) GetUnused() uint32 {
	if x != nil {
		return x.Unused
	}
	return 0
...
var file_http_route_proto_rawDesc = []byte{
	...
	0x61, 0x74, 0x6f, 0x72, 0x22, 0x24, 0x0a, 0x0a, 0x42, 0x69, 0x67, 0x49, 0x63, 0x65, 0x41, 0x75,
	0x74, 0x68, 0x12, 0x16, 0x0a, 0x06, 0x75, 0x6e, 0x75, 0x73, 0x65, 0x64, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x0d, 0x52, 0x06, 0x75, 0x6e, 0x75, 0x73, 0x65, 0x64, 0x42, 0x35, 0x5a, 0x33, 0x67, 0x69,
	...
	0x61, 0x70, 0x69, 0x2f, 0x67, 0x6f, 0x2f, 0x68, 0x74, 0x74, 0x70, 0x5f, 0x72, 0x6f, 0x75, 0x74,
...
var file_http_route_proto_goTypes = []interface{}{
	...
	(*BigIceAuth)(nil),            // 10: io.linkerd.proxy.http_route.BigIceAuth
